...
# Dicke der Schichten
Dicken_Aussenlage  = 0.13
Dicken_Deckschicht = 0.067
Dicken_Entkopplung = 0.1
Dicken_Papier = 0.3

# Vernetzungsize
Default_Elementsize = 0.5
...
# Deck
E_Deck  = 8000                                    # E-Modul der Deckmaterial
Nu_Deck = 0.4                                     # Poissonsrate der Deckmaterial
Expansion_Koeffizient_Deck = 4.1*10**(-5)         # Expansionskoeffizient

# Aussenlage
E_Aussenlage  = 5000                              # E-Modul der Aussenlagematerial
Nu_Aussenlage = 0.4							      # Poissonsrate der Aussenlagematerial
Expansion_Koeffizient_Aussenlage = 2*10**(-4)	  # Expansionskoeffizient der Aussenlagematerial
...
E_Papier  = 3224.621             # E-Modul des Papiers
...
Expansion_Koeffizient_Papier = 1*10**(-5)
# ---------------------------------------------------------------------------------
...
compositeLayup = Part_Deck_O.CompositeLayup(name='Deck_O', description='', elementType=SHELL, offsetType=MIDDLE_SURFACE, symmetric=False, thicknessAssignment=FROM_SECTION)
...
compositeLayup.CompositePly(suppressed=False, plyName='DeckOber', region=region, material='Deckmaterial', thicknessType=SPECIFY_THICKNESS, thickness=Dicken_Deckschicht, orientationType=SPECIFY_ORIENT, orientationValue=0.0, additionalRotationType=ROTATION_NONE, additionalRotationField='', axis=AXIS_3, angle=0.0, numIntPoints=3)
compositeLayup.CompositePly(suppressed=False, plyName='Entkopplung', region=region, material='Entkopplung', thicknessType=SPECIFY_THICKNESS, thickness=Dicken_Entkopplung, orientationType=SPECIFY_ORIENT, orientationValue=0.0, additionalRotationType=ROTATION_NONE, additionalRotationField='', axis=AXIS_3, angle=0.0, numIntPoints=3)
compositeLayup.CompositePly(suppressed=False, plyName='Aussenlage', region=region, material='Aussenlage', thicknessType=SPECIFY_THICKNESS, thickness=Dicken_Aussenlage, orientationType=SPECIFY_ORIENT, orientationValue=0.0, additionalRotationType=ROTATION_NONE, additionalRotationField='', axis=AXIS_3, angle=0.0, numIntPoints=3)

# Unterdeck
face_Deck_U = Part_Deck_U.faces
Part_Deck_U.Set(faces=face_Deck_U, name='Set-Deck_U')
region = Part_Deck_U.sets['Set-Deck_U']
compositeLayup = Part_Deck_U.CompositeLayup(name='Deck_U', description='', elementType=SHELL, offsetType=MIDDLE_SURFACE, symmetric=False, thicknessAssignment=FROM_SECTION)
compositeLayup.Section(preIntegrate=OFF, integrationRule=SIMPSON, thicknessType=UNIFORM, poissonDefinition=DEFAULT, temperature=GRADIENT, useDensity=OFF)
compositeLayup.ReferenceOrientation(orientationType=GLOBAL, localCsys=None, fieldName='', additionalRotationType=ROTATION_NONE, angle=0.0, axis=AXIS_3)
compositeLayup.CompositePly(suppressed=False, plyName='DeckUnter', region=region, material='Deckmaterial', thicknessType=SPECIFY_THICKNESS, thickness=Dicken_Deckschicht, orientationType=SPECIFY_ORIENT, orientationValue=0.0, additionalRotationType=ROTATION_NONE, additionalRotationField='', axis=AXIS_3, angle=0.0, numIntPoints=3)
compositeLayup.CompositePly(suppressed=False, plyName='Entloppung', region=region, material='Entkopplung', thicknessType=SPECIFY_THICKNESS, thickness=Dicken_Entkopplung, orientationType=SPECIFY_ORIENT, orientationValue=0.0, additionalRotationType=ROTATION_NONE, additionalRotationField='', axis=AXIS_3, angle=0.0, numIntPoints=3)
# ---------------------------------------------------------------------------------
...
#
Model.Temperature(name='Predefined Field-1', createStepName='Expansion', region=Assembly.sets['Set-T'], distributionType=UNIFORM, crossSectionDistribution=CONSTANT_THROUGH_THICKNESS, magnitudes=(140.0, ))
###
# Regenerate
#Assembly.regenerate()
# ---------------------------------------------------------------------------------
